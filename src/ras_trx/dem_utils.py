...
def transform_raster_profile(
    profile: dict, bounds: rasterio.coords.BoundingBox, target_crs: CRS
) -> dict:
...
def get_raster_points_and_values(
    src: rasterio.DatasetReader, window: rasterio.windows.Window, data: np.ndarray
) -> list:
